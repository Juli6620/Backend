...
import com.portfolioMJP.mjp.Dto.dtoProyectos;
import com.portfolioMJP.mjp.Entity.Proyectos;
import com.portfolioMJP.mjp.Security.Controller.Mensaje;
import com.portfolioMJP.mjp.Service.SProyectos;
...
@RestController
@RequestMapping("/proy/")
@CrossOrigin(origins = "https://portfoliomjp-40113.web.app/proy/")
public class CProyectos {
    ...
    public ResponseEntity<?> create(@RequestBody dtoProyectos dtoproy){      
        ...
        Proyectos proyecto = new Proyectos(dtoproy.getNombreP(), dtoproy.getDescripcionP(),dtoproy.getFechaP(),dtoproy.getFechaPF());
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoProyectos dtoproy){
        ...
        proyecto.setFechaPF((dtoproy.getFechaPF()));
